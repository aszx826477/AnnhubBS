...
class NotificationCompat$JellybeanExtender extends NotificationCompat$BuilderExtender
{
    public Notification build(final NotificationCompat$Builder notificationCompat$Builder, final NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
        final RemoteViews access$400 = addStyleGetContentViewJellybean(notificationBuilderWithBuilderAccessor, notificationCompat$Builder);
        final Notification build = notificationBuilderWithBuilderAccessor.build();
        if (access$400 != null) {
            build.contentView = access$400;
        }
        addBigStyleToBuilderJellybean(build, notificationCompat$Builder);
        return build;
    }
}
