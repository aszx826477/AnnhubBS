...
class NotificationCompat$IceCreamSandwichExtender extends NotificationCompat$BuilderExtender
{
    public Notification build(final NotificationCompat$Builder notificationCompat$Builder, final NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
        final RemoteViews access$300 = addStyleGetContentViewIcs(notificationBuilderWithBuilderAccessor, notificationCompat$Builder);
        final Notification build = notificationBuilderWithBuilderAccessor.build();
        if (access$300 != null) {
            build.contentView = access$300;
        }
        else if (notificationCompat$Builder.getContentView() != null) {
            build.contentView = notificationCompat$Builder.getContentView();
        }
        return build;
    }
}
