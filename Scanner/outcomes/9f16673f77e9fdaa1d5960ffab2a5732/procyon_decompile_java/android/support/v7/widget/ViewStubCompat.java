...
public final class ViewStubCompat extends View
{
    ...
    public ViewStubCompat(final Context context, final AttributeSet set, final int n) {
        ...
        final int viewStubCompat_android_inflatedId = R$styleable.ViewStubCompat_android_inflatedId;
        final int n2 = -1;
        this.mInflatedId = obtainStyledAttributes.getResourceId(viewStubCompat_android_inflatedId, n2);
        this.mLayoutResource = obtainStyledAttributes.getResourceId(R$styleable.ViewStubCompat_android_layout, 0);
        this.setId(obtainStyledAttributes.getResourceId(R$styleable.ViewStubCompat_android_id, n2));
    ...
    public View inflate() {
        ...
        if (this.mLayoutResource != 0) {
            ...
            final ViewStubCompat$OnInflateListener mInflateListener = this.mInflateListener;
    ...
    public void setVisibility(final int n) {
        final WeakReference mInflatedViewRef = this.mInflatedViewRef;
