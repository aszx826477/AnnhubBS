...
class MediaBrowserServiceCompat$MediaBrowserServiceImplBase$2 implements Runnable
{
    ...
    MediaBrowserServiceCompat$MediaBrowserServiceImplBase$2(final MediaBrowserServiceCompat$MediaBrowserServiceImplBase this$1, final String val$parentId, final Bundle val$options) {
        this.this$1 = this$1;
