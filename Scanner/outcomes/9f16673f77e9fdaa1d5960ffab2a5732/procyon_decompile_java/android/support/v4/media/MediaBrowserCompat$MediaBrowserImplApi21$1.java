...
class MediaBrowserCompat$MediaBrowserImplApi21$1 implements Runnable
{
    ...
    MediaBrowserCompat$MediaBrowserImplApi21$1(final MediaBrowserCompat$MediaBrowserImplApi21 this$0, final MediaBrowserCompat$ItemCallback val$cb, final String val$mediaId) {
        this.this$0 = this$0;
        this.val$cb = val$cb;
