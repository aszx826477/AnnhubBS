...
class MediaBrowserCompat$MediaBrowserImplBase$6 implements Runnable
{
    ...
    MediaBrowserCompat$MediaBrowserImplBase$6(final MediaBrowserCompat$MediaBrowserImplBase this$0, final MediaBrowserCompat$CustomActionCallback val$callback, final String val$action, final Bundle val$extras) {
        this.this$0 = this$0;
