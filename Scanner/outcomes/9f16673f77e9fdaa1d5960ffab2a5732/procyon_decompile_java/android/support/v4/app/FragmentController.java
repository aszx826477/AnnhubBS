...
public class FragmentController
{
    ...
    public List getActiveFragments(final List list) {
    ...
    public void restoreAllState(final Parcelable parcelable, final List list) {
        this.mHost.mFragmentManager.restoreAllState(parcelable, new FragmentManagerNonConfig(list, null));
    }
    
    public void restoreLoaderNonConfig(final SimpleArrayMap simpleArrayMap) {
