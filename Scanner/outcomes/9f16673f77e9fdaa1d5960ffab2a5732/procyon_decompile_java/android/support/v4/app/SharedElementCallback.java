...
public abstract class SharedElementCallback
{
    ...
    private static Bitmap createDrawableBitmap(final Drawable drawable) {
        ...
        final float n = SharedElementCallback.MAX_IMAGE_SIZE / (intrinsicWidth * intrinsicHeight);
        final float n2 = 1.0f;
        final float min = Math.min(n2, n);
        if (drawable instanceof BitmapDrawable && min == n2) {
            return ((BitmapDrawable)drawable).getBitmap();
        }
        final int n3 = (int)(intrinsicWidth * min);
        final int n4 = (int)(intrinsicHeight * min);
    ...
    public View onCreateSnapshotView(final Context context, final Parcelable parcelable) {
        ...
        if (parcelable instanceof Bundle) {
            ...
            final ImageView imageView = (ImageView)(o = new ImageView(context));
            ...
            ((ImageView)(o = new ImageView(context))).setImageBitmap((Bitmap)parcelable);
        }
        return (View)o;
    }
    ...
    public void onSharedElementsArrived(final List list, final List list2, final SharedElementCallback$OnSharedElementsReadyListener sharedElementCallback$OnSharedElementsReadyListener) {
