...
{
    public static List findAccessibilityNodeInfosByViewId(final Object o, final String s) {
        return ((AccessibilityNodeInfo)o).findAccessibilityNodeInfosByViewId(s);
    }
