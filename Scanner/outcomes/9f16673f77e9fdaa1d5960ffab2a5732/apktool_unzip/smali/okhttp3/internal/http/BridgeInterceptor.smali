...
.method public intercept(Lokhttp3/Interceptor$Chain;)Lokhttp3/Response;
    ...
    invoke-interface {v4, v5}, Lokhttp3/CookieJar;->loadForRequest(Lokhttp3/HttpUrl;)Ljava/util/List;

    move-result-object v4

    .line 85
    .local v4, "cookies":Ljava/util/List;, "Ljava/util/List<Lokhttp3/Cookie;>;"
    ...
    invoke-direct {p0, v4}, Lokhttp3/internal/http/BridgeInterceptor;->cookieHeader(Ljava/util/List;)Ljava/lang/String;
    ...
    .line 95
    .local v5, "networkResponse":Lokhttp3/Response;
    ...
    invoke-static {v6, v7, v8}, Lokhttp3/internal/http/HttpHeaders;->receiveHeaders(Lokhttp3/CookieJar;Lokhttp3/HttpUrl;Lokhttp3/Headers;)V
    ...
    .line 105
    invoke-virtual {v8, v9}, Lokhttp3/Headers$Builder;->removeAll(Ljava/lang/String;)Lokhttp3/Headers$Builder;
    ...
    .line 108
    .local v8, "strippedHeaders":Lokhttp3/Headers;
    invoke-virtual {v6, v8}, Lokhttp3/Response$Builder;->headers(Lokhttp3/Headers;)Lokhttp3/Response$Builder;
    ...
    invoke-direct {v9, v8, v10}, Lokhttp3/internal/http/RealResponseBody;-><init>(Lokhttp3/Headers;Lokio/BufferedSource;)V
    ...
    .end local v8    # "strippedHeaders":Lokhttp3/Headers;
    :cond_8
    goto :goto_7
