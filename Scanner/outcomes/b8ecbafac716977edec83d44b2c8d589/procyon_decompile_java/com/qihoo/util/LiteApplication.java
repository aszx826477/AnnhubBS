...
public class LiteApplication extends Application
{
    ...
    static {
        LiteApplication.\u1d62\u02cf = null;
        LiteApplication.loadDexToC = false;
        LiteApplication.\u1d62\u02d1 = new ConcurrentHashMap();
        LiteApplication.selfLoad = true;
    }
    
    public static Context getAppContext() {
        return LiteApplication.\u1d62\u02ce;
    }
    
    public static String getDir() {
        return LiteApplication.\u1d62\u02cf;
    }
    
    public static String getString2(final int n) {
        String interface14 = LiteApplication.\u1d62\u02d1.get(n);
        if (interface14 == null) {
            interface14 = interface14(n);
            LiteApplication.\u1d62\u02d1.put(n, interface14);
        }
        return interface14;
    }
    ...
    public static void load(final Application \u1d62\u02cb, final Context \u1d62\u02ce) {
        final int n = 1;
        LiteApplication.\u1d62\u02cb = \u1d62\u02cb;
        LiteApplication.\u1d62\u02ce = \u1d62\u02ce;
        if (\u1d62\u02ce != null) {
            final File filesDir = LiteApplication.\u1d62\u02ce.getFilesDir();
            if (filesDir != null) {
                LiteApplication.\u1d62\u02cf = filesDir.getParentFile().getAbsolutePath() + "/.jiagu";
            }
        }
        if (!interface20()) {
            System.exit(n);
        ...
        while (true) {
            if (!LiteApplication.loadDexToC) {
                break Label_0099;
            }
            final String s = "jgdtc";
            try {
                System.loadLibrary(s);
                interface5(LiteApplication.\u1d62\u02cb);
                final String s2 = "com.qihoo.bugreport.CrashReport";
                try {
                    final Class<?> forName = Class.forName(s2);
                    forName.getDeclaredMethod("prepareInit", (Class<?>[])new Class[0]).invoke(null, new Object[0]);
                    forName.getDeclaredMethod("init", Context.class).invoke(null, LiteApplication.\u1d62\u02cb);
                }
                finally {}
            }
            catch (Error error) {
